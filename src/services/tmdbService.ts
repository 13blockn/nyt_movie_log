...
export const searchMovieOnTMDb = async (title: string, year: number): Promise<string | null> => {
  if (!TMDB_API_KEY) {
...
export const batchFetchPosters = async (movies: Array<{title: string, year: number}>) => {
